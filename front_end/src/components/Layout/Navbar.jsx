...
export default function NavBar() {
  ...
  <header className="sticky top-0 z-50 bg-white shadow-md border-b border-gray-200">
    {isAuthenticated ? (
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span
                    className={`text-xs font-medium capitalize ${
                      user?.role === 'admin' ? 'text-amber-600' : 'text-teal-600'
                    }`}
                  >
                    {user?.role || 'User'}
                  </span>
                  ...
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex flex-col min-w-0 flex-1">
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold w-fit mt-1 ${
                            user?.role === 'admin'
      ...
      /* 🔵 Unauthenticated Navbar (Fixed colors + logic) */
      <nav className="px-4 py-3 lg:px-8">
        <div className="flex items-center justify-between max-w-screen-xl mx-auto">
          <Link
            to="/"
